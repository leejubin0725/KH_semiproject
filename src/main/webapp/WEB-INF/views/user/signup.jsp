   ...
   <div class="container">
      <div class="signup-form">
         ...
         <form action="${contextPath }/user/insert" method="POST">
            ...
            <!-- ------------------------------------------------ -->
            <div id="vehicle-options" style="display: none;">
               <div class="radio-inputs">
                  <div class="radio-inputs">
                     <label> <input class="radio-input" type="radio"
                        name="vehicle" value="W"> <span class="radio-tile">
                           <span class="radio-icon"> <svg stroke="currentColor"
                                 xml:space="preserve"
                        ...
                        </span> <span class="walk">도보 이동</span>
                     </span>
                     </label> <label> <input class="radio-input" type="radio"
                        name="vehicle" value="B"> <span class="radio-tile">
                           <span class="radio-icon"> <svg stroke="currentColor"
                                 xml:space="preserve" viewBox="0 0 493.407 493.407"
                                 xmlns:xlink="http://www.w3.org/1999/xlink"
                                 xmlns="http://www.w3.org/2000/svg" id="Capa_1" version="1.1"
                                 width="200px" height="200px" fill="none">
                                 <g stroke-width="0"
                                    id="SVGRepo_bgCarrier"></g>
                                 <g stroke-linejoin="round"
                                    stroke-linecap="round" id="SVGRepo_tracerCarrier"></g>
                        ...
                        </span> <span class="radio-label">Bicycle</span>
                     </span>
                     </label> <label> <input checked="" class="radio-input"
                        type="radio" name="vehicle" value="M"> <span
                        ...
                        </span> <span class="radio-label">Motorbike</span>
                     </span>
                     </label> <label> <input class="radio-input" type="radio"
                        name="vehicle" value="C"> <span class="radio-tile">
                           <span class="radio-icon"> <svg stroke="currentColor"
                                 xml:space="preserve" viewBox="0 0 324.018 324.017"
                                 xmlns:xlink="http://www.w3.org/1999/xlink"
                                 xmlns="http://www.w3.org/2000/svg" id="Capa_1" version="1.1"
                                 fill="none">
                                 <g stroke-width="0"
                                 ...
                                 <g id="SVGRepo_iconCarrier"> <g> <g> <path
                                    ...
                                    d="M52.17,195.175c3.638,5.379,9.794,8.922,16.756,8.922c0.228,0,0.44-0.062,0.663-0.073c2.576-0.083,5.043-0.61,7.291-1.574 c1.574-0.678,2.996-1.6,4.332-2.636c4.782-3.702,7.927-9.429,7.927-15.933c0-11.144-9.066-20.216-20.212-20.216 s-20.213,9.072-20.213,20.216c0,2.263,0.461,4.411,1.149,6.446c0.288,0.85,0.616,1.673,1.015,2.471 C51.279,193.606,51.667,194.434,52.17,195.175z"></path> <path
                                    d="M269.755,209.068c2.656,0,5.173-0.549,7.503-1.481c1.589-0.642,3.06-1.491,4.422-2.495 c1.035-0.767,1.988-1.616,2.863-2.559c3.34-3.604,5.432-8.389,5.432-13.681c0-11.144-9.071-20.21-20.215-20.21 s-20.216,9.066-20.216,20.21c0,4.878,1.812,9.3,4.702,12.801c0.818,0.989,1.719,1.89,2.708,2.713 c1.311,1.088,2.729,2.024,4.293,2.755C263.836,208.333,266.704,209.068,269.755,209.068z"></path> </g> </g> </g></svg>
                        </span> <span class="radio-label">Car</span>
                     </span>
                     </label>
            ...
            <div class="category-selector">
               <div>
                  <label> <input type="radio" name="gender" id="radio"
                     value="W" checked=""> <span>Women</span>
                  </label> <label> <input type="radio" name="gender" id="radio"
                     value="M"> <span>Men </span>
                  </label>
         ...
         <div class="image-container">
            <img src="${contextPath }/resources/images/cut_2.png">
         </div>
      </div>
