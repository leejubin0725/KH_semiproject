...
<body>
    <div class="container">
        <div class="signup-form">
            ...
            <form action="${contextPath }/user/insert" method="POST" onsubmit="return cleanPhoneNumber()">
            <div class="radio-input-wrapper">
                <label class="label">
                    <input value="regular" name="role" id="regular" class="radio-input" type="radio" checked>
                    <div class="radio-design"></div>
                    <div class="label-text">일반회원</div>
                </label>
                <label class="label">
                    <input value="rider" name="role" id="rider" class="radio-input" type="radio">
                    <div class="radio-design"></div>
            ...
            <div class="radio-inputs">
                ...
                <label>
                    <input checked="" class="radio-input" type="radio" name="vehicle" value="Motobike">
                    <span class="radio-tile">
                        <span class="radio-icon">
                ...
                <label>
                    <input class="radio-input" type="radio" name="vehicle" value="Car">
                    <span class="radio-tile">
                        <span class="radio-icon">
            ...
            <div class="form-group">
                ...
                <input type="text" id="nickname"  name ="nickname"  placeholder="사용할 닉네임을 입력하세요.">
            </div>
            
            <div class="form-group">
                <label for="name">생년월일</label>
                <input type="text" id="birth" name ="birth"  maxlength="10" placeholder="생년월일을 입력하세요. ex) 2000.02.17 - > 000217">
            </div>
           <div class="form-group">
                <label for="phone">전화번호</label>
                <input type="text" id="phone" name="phone" maxlength="13" placeholder="010-0000-0000" oninput="formatPhoneNumber(this)">
           </div>
       	...
       	<button type="submit" class="tooltip">회원가입</button>
    </form>
