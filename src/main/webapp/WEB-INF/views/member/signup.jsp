    ...
    <div class="container">
        <div class="signup-form">
            ...
            <div class="radio-input-wrapper">
                <label class="label">
                    <input value="regular" name="member-type" id="regular" class="radio-input" type="radio" checked>
                    <div class="radio-design"></div>
                    <div class="label-text">일반회원</div>
                </label>
                <label class="label">
                    <input value="rider" name="member-type" id="rider" class="radio-input" type="radio">
                    <div class="radio-design"></div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="name" placeholder="실제 사용하는 이메일을 입력하세요. ">
            </div>
            <div class="form-group">
                <label for="name">비밀번호</label>
                <input type="text" id="name" placeholder="비밀번호를 입력하세요.">
            </div>
            <div class="form-group">
                <label for="name">닉네임</label>
                <input type="text" id="name" placeholder="사용할 닉네임을 입력하세요.">
            </div>
            
            <div class="form-group">
                <label for="name">생년월일</label>
                <input type="text" id="name" placeholder="생년월일을 입력하세요. ex) 2000.02.17 - > 000217">
            </div>
            <div class="form-group">
                <label for="password">전화번호</label>
                <input type="password" id="password" placeholder="휴대폰 번호를 입력하세요. ex)01030532345">
            </div>
            <div class="form-group">
                <label for="password">주소</label>
                <input type="password" id="password" placeholder="주소를 입력하세요.">
            </div>
