    ...
    <div class="container">
        <div class="signup-form">
            ...
            <div class="radio-input-wrapper">
                <label class="label">
                    <input value="regular" name="member-type" id="regular" class="radio-input" type="radio" value="U" checked>
                    <div class="radio-design"></div>
                    <div class="label-text">일반회원</div>
                </label>
                <label class="label">
                    <input value="rider" name="member-type" id="rider" class="radio-input" type="radio" value="R">
                    <div class="radio-design"></div>
            ...
            <div class="radio-inputs">
                <label>
                    <input class="radio-input" type="radio" name="vehicle" value="W">
                ...
                <label>
                    <input class="radio-input" type="radio" name="vehicle" value="B">
                        <span class="radio-tile">
                            <span class="radio-icon">
                ...
                <label>
                    <input checked="" class="radio-input" type="radio" name="vehicle" value="M">
                    <span class="radio-tile">
                        <span class="radio-icon">
                ...
                <label>
                    <input class="radio-input" type="radio" name="vehicle" value="C">
                    <span class="radio-tile">
                        <span class="radio-icon">
            ...
            <div class="form-group">
                ...
                <input type="text" id="birth" name ="birth" placeholder="생년월일을 입력하세요. ex) 2000.02.17 - > 000217">
            </div>
            <div class="form-group">
                <label for="password">전화번호</label>
                <input type="password" id="phone" name ="phone" placeholder="휴대폰 번호를 입력하세요. ex)01030532345">
            </div>
            <div class="form-group">
                <label for="password">주소</label>
                <input type="password" id="address" name ="address" placeholder="주소를 입력하세요.">
            </div>
