...
<body>
    ...
    <div class="mypage-body">
        <div class="mypage-container">
            ...
            <button class="mypage-button" onclick="myPost()">내가 쓴 글</button>
    ...
    <script>
        function myPost() {
            window.location.href = "${pageContext.request.contextPath}/board/myPost";
        }
        ...
        function confirmDelete() {
            // 회원탈퇴 로직
            window.location.href = "${pageContext.request.contextPath}/member/deleteAccount.jsp";
        }
    </script>
   <!-- <script src="${pageContext.request.contextPath}/resources/js/mypage-script.js"></script> -->
</body>
</html>
